...
public class barras extends ApplicationFrame {
   
   public barras( String applicationTitle , String chartTitle, int [][]mat, int alto, int ancho, int limedad, int limeadad2,int inicodevectestado, int finaldevectesado ) {
      ...
      JFreeChart barChart = ChartFactory.createBarChart(
         ...
         "",            
         "",            
         createDataset(res,alt,anch,as,as2,vectestadoin,vectestadofin),          
   ...
   private CategoryDataset createDataset(int [][]mat, int alto, int ancho, int limedad, int limeadad2,int inicodevectestado, int finaldevectesado ) {
    int res[][]= new int[alto][ancho];
        int as=limedad;
        int as2= limeadad2;
        for(int x=0; x<alto; x++){
